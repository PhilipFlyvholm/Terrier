...
export function compileScript(component: TerrierComponent): void {
                    ...
                    switch (expression.type) {
                      case "AssignmentExpression": {
                        ...
                        if (left.type !== "Identifier") {
                          ...
                          throw Error(
                            `Unknown type for Assignment ${type} @ ${pos}`
                          ); // TODO: Remove/fix before 1.0
                        }
                        ...
                        console.log(
                          variableName,
                          operator,
                          script.substring(right.start, right.end)
                        );
